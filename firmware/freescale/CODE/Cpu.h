...
#define PEcfg_Debug_S08JS16CWJ 1
...
#define CPU_DERIVATIVE_MC9S08JS16      /* Name of the selected cpu derivative */
#define CPU_PARTNUM_MC9S08JS16CWJ      /* Part number of the selected cpu */
